...
// See sys_core\script_component.hpp:30 (might change) for macro definition
SPATIALIZATION_SETTINGS(PRC343);
SPATIALIZATION_SETTINGS(PRC152);
SPATIALIZATION_SETTINGS(PRC148);
SPATIALIZATION_SETTINGS(PRC117F);
SPATIALIZATION_SETTINGS(PRC77);
SPATIALIZATION_SETTINGS(SEM52SL);
SPATIALIZATION_SETTINGS(SEM70);
SPATIALIZATION_SETTINGS(BF888S);
SPATIALIZATION_SETTINGS(VRC64);
SPATIALIZATION_SETTINGS(VRC103);
SPATIALIZATION_SETTINGS(VRC110);
SPATIALIZATION_SETTINGS(VRC111);
SPATIALIZATION_SETTINGS(SEM90);
